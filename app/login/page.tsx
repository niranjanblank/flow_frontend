...
import { FaMobileAlt, FaRegCheckCircle, FaRegClock, FaTasks } from "react-icons/fa";
    ...
    return (
        ...
        <div className="bg-zinc-800 flex items-center justify-center p-8 text-white">
            <div className="text-center">
                ...
                <p className="text-lg mt-8">Don't have an account? <Link href="/signup" className="underline font-bold">Sign Up</Link></p>
            </div>
        </div>
    </div>
    )
